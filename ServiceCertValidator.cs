...
namespace CertificateMenager
{
    public class ServiceCertValidator : X509CertificateValidator
    {
		...
		public override void Validate(X509Certificate2 certificate)
        {
            ...
            X509Certificate2 srvCert = CertMenager.GetCertificateFromStorage(StoreName.My, StoreLocation.LocalMachine, Formatter.ParseName(WindowsIdentity.GetCurrent().Name));
